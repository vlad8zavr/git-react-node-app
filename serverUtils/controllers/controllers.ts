...
// showAllRepos2
// req - Object
// res.json: (object: Object) => (return this.send(body: sting))
...
exports.showAllRepos2 = (req: Object, res: ShowAllReposRes) => {
    const options: Options = { withFileTypes: true };
    global.pathToRep && _showAllRepos2(req, res, fs, global.pathToRep, options, callbackShowAllRepos);
}

// -----------------------------------------

const _showTree2 = (req: ReqShowTree, res: ShowAllReposRes, thispath: string, testData: string | boolean, callbackReturn: (testData: string | boolean, param: string) => void) => {
...
exports.showTree2 = (req: ReqShowTree, res: ShowAllReposRes) => {
